"""
Django settings for MessedUpSite project.
...
PROJECT_DIR = os.path.join(BASE_DIR, "MessedUpSite")
...
SECRET_KEY = "django-insecure-qk2^11@8#hy0s2th+@qjaz99cn*fcf@e8_5@5v1b+iwq3mn59x"
...
ROOT_URLCONF = "MessedUpSite.urls"
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            "context_processors": [
                ...
                "MessedUpSite.apps.quotes.context_processors.random_quote",
            ],
        },
    },
]

WSGI_APPLICATION = "MessedUpSite.wsgi.application"
